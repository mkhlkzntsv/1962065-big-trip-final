...
const createTripSortTemplate = (sortType) => (
  `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item--day">
              ...
              name="trip-sort" value="sort-day" data-sort-type="${SortType.SORT_DAY}"
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              ...
              name="trip-sort" value="sort-time" data-sort-type="${SortType.SORT_TIME}"
            ...
            <div class="trip-sort__item  trip-sort__item--price">
              ...
              name="trip-sort" value="sort-price" data-sort-type="${SortType.SORT_PRICE}"
